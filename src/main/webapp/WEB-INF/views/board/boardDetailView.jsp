...
<hr>
<h1 align="center">${ requestScope.board.boardNum } 번 게시물 상세보기</h1>
<br>
...
<table align="center" width="500" border="1" cellspacing="0" cellpadding="5">
	...
	<%-- 로그인한 경우에 표시되게 함 --%>
		<c:if test="${ !empty sessionScope.loginUser }">
			<%-- 본인이 작성한 글 또는 관리자이면 수정, 삭제 버튼 제공 --%>
			...
			<%-- 본인이 작성한 글이 아니거나 관리자이면 댓글달기 버튼 표시 --%>
			<c:if test="${ loginUser.userId ne board.boardWriter or loginUser.adminYN eq 'Y' }">
				<%-- 글 레벨이 3보다 작은(2까지) 경우에만 댓글달기 버튼 표시 : 대댓글까지만 등록하게 할 것 --%>
